  ...
  return (
    <div>
      ...
      <div className="max-w-[1400px] mx-auto xxs:px-4 min-[1400px]:px-0">
        <AutoServiceCard
          reverse={true}
          icon={<MdLocalCarWash className="text-3xl white-yellow gray-bg" />}
          ...
          src="/capital-mech/images/luxury car wash/exterior_wash.jpg"
          button={false}
          buttonText="SEE MORE"
        />
        <AutoServiceCard
          reverse={false}
          icon={<BsStars className="text-3xl white-yellow gray-bg" />}
          ...
          src="/capital-mech/images/luxury car wash/interior_detail.jpg"
          button={false}
          buttonText="SEE MORE"
        />
        <AutoServiceCard
          reverse={true}
          icon={<MdFrontHand className="text-3xl white-yellow gray-bg" />}
          title="Hand Wax & Buff"
          ...
          src="/capital-mech/images/luxury car wash/buff.jpg"
          button={false}
          buttonText="SEE MORE"
        />
        <AutoServiceCard
          reverse={false}
          icon={<GiCartwheel className="text-3xl white-yellow gray-bg" />}
          ...
          src="/capital-mech/images/luxury car wash/rim_cleaning.jpg"
          button={false}
          buttonText="SEE MORE"
        />
        <AutoServiceCard
          reverse={true}
          icon={<BiSolidSprayCan className="text-3xl white-yellow gray-bg" />}
          ...
          src="/capital-mech/images/luxury car wash/paint_protection.jpg"
          button={false}
          buttonText="SEE MORE"
        />
      </div>
